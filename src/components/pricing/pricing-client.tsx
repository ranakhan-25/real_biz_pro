...
export function PricingClient() {
  ...
  return (
    <section className="bg-background px-5 py-16 md:px-8 md:py-24 transition-colors">
      <div className="mx-auto max-w-7xl">
        ...
        >
          <span className="chip-kinetic font-mono">
            {t("pricing.badge")}
          </span>
          ...
          <AnimatePresence>
            {billing === "yearly" && (
              <motion.span
                ...
                className="inline-flex items-center gap-1 rounded-full bg-accent/20 px-2.5 py-1 text-[11px] font-semibold text-foreground border border-accent/40"
              >
          ...
          {PLANS.map((plan, index) => (
            <motion.div
              ...
              className={`relative flex flex-col rounded-2xl border bg-card p-7 transition-all ${
                plan.highlighted
                  ? "border-accent ring-2 ring-accent/50 shadow-xl md:-translate-y-2"
