          ...
          {SOLUTIONS.map((item) => {
            ...
            return (
              <motion.div
                ...
                className={`flex flex-col items-start rounded-2xl border border-border bg-card p-6 text-left shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:ring-2 hover:shadow-xl ${item.hoverBorder} ${item.hoverRing}`}
              >
                <span
