...
export default function ShiftListPage() {
  ...
  // Modal Submit Handler (API Ready)
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-black text-slate-800 dark:text-slate-100 p-4 md:p-6 transition-colors duration-200">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {/* Modal খোলার জন্য onClick handler যুক্ত করা হয়েছে */}
        <button
                ...
                <table className="w-full text-xs border-collapse">
                  <thead>
                    <tr className="bg-indigo-600 dark:bg-indigo-600/90 text-white font-semibold">
                      <th className="p-2.5 text-left w-1/3 border-r border-indigo-500/30">
                        DAY
                      </th>
                      <th className="p-2.5 text-left w-1/3 border-r border-indigo-500/30">
                        FROM TIME
                      </th>
                      <th className="p-2.5 text-left w-1/3">
                        TO TIME
                      </th>
                    </tr>
                  </thead>
