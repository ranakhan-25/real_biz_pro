...
// =====================================================
// Mock Data (Based on image_7d18e3.jpg)
// =====================================================
...
const reportData: ProjectOverviewReportData = {
  ...
  budgetEstimatedAmount: "15,000,000.00",
  income: "0.00",
  expense: "1,176.00",
  availableAmount: "14,998,824.00",
  profitAmount: "-1,176.00",
  billSubmission: "0.00",
  receiveAmount: "0.00",
  due: "0.00",

  cashBankBalances: [
    { sl: 1, account: "Cash", balance: "-24,676" },
  ],

  expenses: [
    { accountsDetails: "Bricks Consumption", subtotal: "45,000.00", total: "-" },
    { accountsDetails: "Rod Consumption", subtotal: "17,760.00", total: "-" },
    { accountsDetails: "Sand Consumption", subtotal: "1,602.00", total: "-" },
    { accountsDetails: "Total Expense (-)", subtotal: "64,362.00", total: "-" },
  ],
  ...
  management: ["Admin", "Tazmul Reza", "Rifat Hosain"],
                ...
                <tbody className="divide-y divide-slate-100 text-xs font-medium text-slate-700">
                  {data.payables.map((row) => (
                    <tr key={row.sl} className="hover:bg-slate-50">
                      ...
                      <td className="py-2.5 px-3">{row.openingBalance}</td>
                      <td className="py-2.5 px-3">{row.debit}</td>
                      <td className="py-2.5 px-3 text-amber-600 font-bold">{row.credit}</td>
                      <td className="py-2.5 px-3 text-blue-600 font-bold">{row.balance}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
