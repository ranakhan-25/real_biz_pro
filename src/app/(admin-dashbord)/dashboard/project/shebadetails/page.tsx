...
// =====================================================
// Mock Data (Based on image_7d8d05.jpg)
// =====================================================
...
const reportData: ProjectOverviewReportData = {
  ...
  budgetEstimatedAmount: "2,000,000.00",
  income: "0.00",
  expense: "45,000.00",
  availableAmount: "1,955,000.00",
  profitAmount: "-45,000.00",
  billSubmission: "0.00",
  receiveAmount: "800,000.00",
  due: "-800,000.00",

  cashBankBalances: [
    { sl: 1, account: "Cash", balance: "754,830" },
  ],

  expenses: [
    { accountsDetails: "Rod Consumption", subtotal: "820.00", total: "-" },
    { accountsDetails: "Total Expense (-)", subtotal: "820.00", total: "-" },
  ],
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm flex flex-col">
            ...
            <div className="p-4 space-y-3 flex-1 text-xs font-semibold text-slate-700">
              {data.management.length === 0 ? (
                <p className="text-slate-400 italic">No management assigned</p>
              ) : (
                ...
                <tbody className="divide-y divide-slate-100 text-xs font-medium text-slate-700">
                  {data.receivables.map((row) => (
                    <tr key={row.sl} className="hover:bg-slate-50">
                      ...
                      <td className="py-2.5 px-3 font-semibold text-blue-600">{row.customerName}</td>
