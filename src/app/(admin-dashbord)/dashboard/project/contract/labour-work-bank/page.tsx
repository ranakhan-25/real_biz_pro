...
// Fully packed mock data with 10 entries to eliminate empty spaces
const initialWorkers: Worker[] = [
  {
    ...
    under: 'Contractor',
    ledgerEntries: [
      { id: 1, date: '24-08-2026', project: 'Lake Garden', description: 'Closing Stock', voucherNo: 'PUR864886', debit: 0, credit: 250.00, balance: 250.00, note: '' }
    ]
  },
  {
    id: 2,
    ...
    under: 'Worker',
    ledgerEntries: [
      { id: 1, date: '10-07-2026', project: 'City Center', description: 'Advance Payment', voucherNo: 'ADV102938', debit: 500, credit: 0, balance: -500.00, note: 'Weekly advance' }
    ]
  },
  {
    id: 3,
...
export default function WorkerContractorPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 p-4 sm:p-6 space-y-4">
      ...
      {(isAddOpen || isEditOpen) && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-xs p-4 overflow-y-auto">
          <div className="bg-slate-50 border border-slate-200 w-full max-w-3xl rounded-xl shadow-2xl overflow-hidden">
            ...
            <form onSubmit={isAddOpen ? handleAddSubmit : handleEditSubmit} className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  disabled
                  value={formData.code || ''}
                  className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-500 focus:outline-none"
                />
              </div>
              ...
              <div className="sm:col-span-2 flex items-center justify-end gap-3 pt-4 border-t border-slate-200 mt-2">
                <button
                  type="button"
                  onClick={() => { setIsAddOpen(false); setIsEditOpen(false); }}
              ...
              <div className="max-w-md mx-auto bg-white border border-slate-200 rounded-2xl shadow-xs overflow-hidden">
                ...
                <div className="pt-10 pb-4 px-6 text-center">
                  ...
                  <div className="mt-3 border-t border-slate-100 divide-y divide-slate-100 text-xs text-left">
                    ...
                    <div className="py-2 flex justify-between"><span className="text-slate-400">Company</span><span className="font-medium text-slate-800">{selectedWorker.business || '—'}</span></div>
