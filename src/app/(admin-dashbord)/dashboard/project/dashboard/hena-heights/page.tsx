...
interface ProjectDashboardData {
  ...
  // Financial Progress Chart Data
  financialProgressData: {
    name: string;
    budget: number;
    cost: number;
  }[];
...
// =====================================================
// Mock Data (Based on image_7d2809.png)
// =====================================================
...
const projectData: ProjectDashboardData = {
  ...
  hoursRemaining: 12,
  minutesRemaining: 10,
  overallReportHref: "/dashboard/project/overall-report/hena-heights",
  ...
  financialProgressData: [
    {
      name: "1st Floor Brick Sampling Works",
      budget: 7430000,
      cost: 11,
    },
  ],
    ...
    <div className="min-h-screen bg-slate-100 font-sans text-slate-900 pb-12">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-3 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
        ...
        <div className="flex items-center gap-2 bg-amber-50 border border-amber-200/60 px-4 py-1.5 rounded-full text-xs font-bold text-slate-700 shadow-sm">
          <span className="text-red-500 font-black">{data.daysRemaining}</span> Day :{" "}
          <span className="text-slate-900 font-black">{data.hoursRemaining}</span> Hour :{" "}
          <span className="text-slate-900 font-black">{data.minutesRemaining}</span> Second
        </div>
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/dashboard/project/hena-heightsdetails"
      ...
      <div className="max-w-[1600px] mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Left: Working Progress & Financial Progress Bar Chart */}
          <div className="lg:col-span-7 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm flex flex-col justify-between">
            <div className="text-center mb-2">
              ...
              <p className="text-xs text-slate-500 mt-1">1st Floor Brick Sampling Works</p>
            </div>

            <div className="my-2 text-center flex items-center justify-center gap-6">
              <span className="text-xs font-bold text-slate-500 tracking-wide uppercase flex items-center gap-1.5">
                <span className="h-2.5 w-2.5 rounded-sm bg-blue-500 inline-block" /> Budget
              </span>
              <span className="text-xs font-bold text-slate-500 tracking-wide uppercase flex items-center gap-1.5">
                <span className="h-2.5 w-2.5 rounded-sm bg-red-500 inline-block" /> Cost
              </span>
            </div>
            ...
            <div className="h-[320px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data.financialProgressData} barSize={60}>
