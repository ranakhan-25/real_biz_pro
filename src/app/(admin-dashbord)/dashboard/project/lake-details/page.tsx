    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-9 gap-3">
        ...
        <div className="bg-emerald-100 p-3 rounded-lg text-center border border-emerald-200">
          ...
          <div className="text-sm font-bold text-emerald-700 mt-1">136,163,000.00</div>
        </div>
        ...
        <div className="bg-rose-100 p-3 rounded-lg text-center border border-rose-200">
          ...
          <div className="text-sm font-bold text-rose-700 mt-1">13,850.00</div>
        </div>
        ...
        <div className="bg-amber-100 p-3 rounded-lg text-center border border-amber-200">
          ...
          <div className="text-sm font-bold text-amber-700 mt-1">-13,850.00</div>
        </div>
        ...
        <div className="bg-purple-100 p-3 rounded-lg text-center border border-purple-200">
          ...
          <div className="text-sm font-bold text-purple-700 mt-1">136,149,150.00</div>
        </div>
        ...
        <div className="bg-teal-100 p-3 rounded-lg text-center border border-teal-200">
          ...
          <div className="text-sm font-bold text-teal-700 mt-1">33,217,166.66</div>
        </div>
        ...
        <div className="bg-orange-100 p-3 rounded-lg text-center border border-orange-200">
          ...
          <div className="text-sm font-bold text-orange-700 mt-1">-33,217,166.66</div>
        </div>
      </div>
          ...
          <table className="w-full text-xs text-left">
            ...
            <tbody className="divide-y divide-gray-100">
              <tr>
                ...
                <td className="p-2 text-right">32,397,167</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table className="w-full text-xs text-left">
            ...
            <tbody className="divide-y divide-gray-100">
              <tr>
                ...
                <td className="p-2">136,163,000.00</td>
                <td className="p-2 text-right">-</td>
              </tr>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs text-left">
              ...
              <tbody className="divide-y divide-gray-100">
                <tr>
                  <td className="p-2">1</td>
                  <td className="p-2">Mostafa</td>
                  <td className="p-2">95,800,000.00</td>
                  <td className="p-2">0.00</td>
                  <td className="p-2">0.00</td>
                  <td className="p-2">95,800,000.00</td>
                </tr>
                <tr>
                  ...
                  <td className="p-2">Abul</td>
                  <td className="p-2">6,530,000.00</td>
                  <td className="p-2">0.00</td>
                  <td className="p-2">0.00</td>
                  <td className="p-2">6,530,000.00</td>
                </tr>
                <tr>
                  ...
                  <td className="p-2">28,682,500.00</td>
                  <td className="p-2">0.00</td>
                  <td className="p-2">0.00</td>
                  <td className="p-2">28,682,500.00</td>
                </tr>
                <tr>
                  ...
                  <td className="p-2">Mr. Raju raz</td>
                  <td className="p-2">0.00</td>
                  <td className="p-2">0.00</td>
                  <td className="p-2">28,066,666.66</td>
                  <td className="p-2 text-rose-600">-28,066,666.66</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs text-left">
              ...
              <tbody className="divide-y divide-gray-100">
                <tr>
                  <td className="p-2">1</td>
                  <td className="p-2">Prime Tiles</td>
                ...
                <tr>
                  <td className="p-2">2</td>
                  <td className="p-2">Southern Park</td>
                ...
                <tr>
                  <td className="p-2">4</td>
                  <td className="p-2">Rifat Thai House</td>
                  <td className="p-2">0.00</td>
                  <td className="p-2">0.00</td>
                  <td className="p-2">9,999.00</td>
                  <td className="p-2">9,999.00</td>
                </tr>
              </tbody>
            </table>
