...
const ALL_ROWS = [
  { id: 1, department: "Business Development", designation: "Jr Executive" },
  { id: 2, department: "Business Development", designation: "HOS" },
  { id: 3, department: "Business Development", designation: "Executive" },
  { id: 4, department: "Business Development", designation: "TL" },
  { id: 5, department: "Business Development", designation: "GL" },
  { id: 6, department: "Business Development", designation: "Co-Ordinator" },
  { id: 7, department: "Accounts", designation: "Manager" },
  { id: 8, department: "Sales and Marketing", designation: "Team Leader" },
  { id: 9, department: "Test", designation: "Messanger" },
  { id: 10, department: "Store", designation: "Coveredvan Helper" },
  { id: 11, department: "Business Development", designation: "Senior Executive" },
  { id: 12, department: "Accounts", designation: "Accountant" },
  { id: 13, department: "Sales and Marketing", designation: "Sales Executive" },
  { id: 14, department: "Store", designation: "Store Keeper" },
  { id: 15, department: "IT", designation: "Developer" },
  { id: 16, department: "IT", designation: "System Admin" },
  { id: 17, department: "HR", designation: "HR Manager" },
  { id: 18, department: "HR", designation: "HR Executive" },
  { id: 19, department: "Mechanical", designation: "Engineer" },
  { id: 20, department: "Electrical", designation: "Technician" },
];
    ...
    <div className="min-h-screen bg-canvas text-ink">
      ...
      <div className="bg-surface border-b border-border px-5 py-2.5 flex items-center justify-between">
        <div className="flex items-center gap-1 text-[13px]">
          ...
          <span className="text-ink-faint mx-1">›</span>
          <span className="text-ink font-medium">Designation List</span>
        </div>
            ...
            <table className="w-full text-left text-[12.5px]">
              <thead>
                <tr className="bg-black text-white">
                  {["SL", "DEPARTMENT", "DESIGNATION", "ACTION"].map((h) => (
                ...
                {pageRows.length === 0 ? (
                  ...
                  pageRows.map((row) => (
                    <tr key={row.id} className="border-b border-border hover:bg-canvas/70">
                      ...
                      <td className="px-3 py-2.5 text-ink font-medium">{row.designation}</td>
