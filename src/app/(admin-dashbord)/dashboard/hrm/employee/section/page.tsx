    ...
    <div className="min-h-screen bg-canvas text-ink">
      ...
      <div className="bg-surface border-b border-border px-5 py-2.5 flex items-center justify-between">
        <div className="flex items-center gap-1 text-[13px]">
          ...
          <span className="text-ink-faint mx-1">›</span>
          <span className="text-ink font-medium">Section List</span>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-[12.5px]">
              ...
              <tbody>
                {pageRows.length === 0 ? (
                  <tr>
                    <td colSpan={3} className="px-3 py-10 text-center text-ink-faint">
                      No records found
                    </td>
                  </tr>
                ) : (
